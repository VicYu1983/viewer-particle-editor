...
/******/ 	return __webpack_require__(__webpack_require__.s = "./extensions/MixpanelProvider/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
Mixpanel = /*#__PURE__*/function (_Autodesk$Viewing$Pri) {_inherits(Mixpanel, _Autodesk$Viewing$Pri);var _super = _createSuper(Mixpanel);
  function Mixpanel(options) {var _this;_classCallCheck(this, Mixpanel);
...

    {
      ...
      mixpanel_browser__WEBPACK_IMPORTED_MODULE_0___default.a.init(this.options.token, this.options.config);
    ...
    // These are sent with every track request
      ...
      mixpanel_browser__WEBPACK_IMPORTED_MODULE_0___default.a.register(props);
    ...
    {
      return mixpanel_browser__WEBPACK_IMPORTED_MODULE_0___default.a.has_opted_out_tracking();
    } }, { key: "optOut", value: function optOut(

    options) {
      // Opt a user out of data collection
      this.track('OptOutTracking');
      mixpanel_browser__WEBPACK_IMPORTED_MODULE_0___default.a.opt_out_tracking(options);
    } }, { key: "getDistinctId", value: function getDistinctId()

    {
      return mixpanel_browser__WEBPACK_IMPORTED_MODULE_0___default.a.get_distinct_id();
    } }, { key: "optIn", value: function optIn(

    options) {
      // Opt the user in to data tracking
      mixpanel_browser__WEBPACK_IMPORTED_MODULE_0___default.a.opt_in_tracking(options);
      this.track('OptInTracking');
    } }, { key: "track", value: function track(

    event, properties) {
      mixpanel_browser__WEBPACK_IMPORTED_MODULE_0___default.a.track(event, properties);
    }
    ...
    distinctId) {
      mixpanel_browser__WEBPACK_IMPORTED_MODULE_0___default.a.identify(distinctId);
