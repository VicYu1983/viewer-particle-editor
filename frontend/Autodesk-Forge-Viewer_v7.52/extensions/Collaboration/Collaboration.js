...
/* harmony import */ var _net_MessageClient__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./net/MessageClient */ "./extensions/Collaboration/net/MessageClient.js");
...
CollabPromptBox.prototype.start = function (container, cb, titleText, buttonText, isInviteWindow) {
  ...
  input.onkeyup = function (e) {
    if (e.keyCode == 13) {
      ...
      Object(_net_MessageClient__WEBPACK_IMPORTED_MODULE_0__["setUserName"])(input.value);
      cb();
    }
  };
  ...
  if (isInviteWindow) {
    text = _document.createElement("span");
    text.className = "collabBoxText";
    text.style.marginTop = "0px";
    label = "Copy and send this URL to invite others";
...
/* harmony import */ var _net_LiveReviewClient__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./net/LiveReviewClient */ "./extensions/Collaboration/net/LiveReviewClient.js");
/* harmony import */ var _net_MessageClient__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./net/MessageClient */ "./extensions/Collaboration/net/MessageClient.js");
/* harmony import */ var _CollabUI_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./CollabUI.css */ "./extensions/Collaboration/CollabUI.css");
/* harmony import */ var _CollabUI_css__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_CollabUI_css__WEBPACK_IMPORTED_MODULE_4__);
...
proto.load = function () {
  ...
  function init() {
    ...
    scope.client = _net_MessageClient__WEBPACK_IMPORTED_MODULE_3__["MessageClient"].GetInstance(scope.options ? scope.options.messageServerURL : undefined);
...
proto.joinLiveReview = function (sessionId) {
  if (!this.liveReviewClient) {
    this.liveReviewClient = new _net_LiveReviewClient__WEBPACK_IMPORTED_MODULE_2__["LiveReviewClient"](this);
  }

  this.liveReviewClient.joinLiveReviewSession(sessionId);
};
proto.leaveLiveReview = function () {
  if (this.liveReviewClient) {
...
proto.getMessageClientInstance = function (serverUrls, path) {
  return _net_MessageClient__WEBPACK_IMPORTED_MODULE_3__["MessageClient"].GetInstance(serverUrls, path);
};
av.theExtensionManager.registerExtension('Autodesk.Viewing.Collaboration', Collaboration);

/***/ }),

/***/ "./extensions/Collaboration/net/LiveReviewClient.js":
/*!**********************************************************!*\
  !*** ./extensions/Collaboration/net/LiveReviewClient.js ***!
  \**********************************************************/
/*! exports provided: LiveReviewClient, InteractionInterceptor, ViewTransceiver */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LiveReviewClient", function() { return LiveReviewClient; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "InteractionInterceptor", function() { return InteractionInterceptor; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ViewTransceiver", function() { return ViewTransceiver; });
/* harmony import */ var _MessageClient__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./MessageClient */ "./extensions/Collaboration/net/MessageClient.js");



var av = Autodesk.Viewing;
var ViewerState = av.Private.ViewerState;var
EventDispatcher =

av.EventDispatcher,GlobalManagerMixin = av.GlobalManagerMixin,CAMERA_CHANGE_EVENT = av.CAMERA_CHANGE_EVENT,SELECTION_CHANGED_EVENT = av.SELECTION_CHANGED_EVENT,ISOLATE_EVENT = av.ISOLATE_EVENT,HIDE_EVENT = av.HIDE_EVENT,SHOW_EVENT = av.SHOW_EVENT,EXPLODE_CHANGE_EVENT = av.EXPLODE_CHANGE_EVENT,LAYER_VISIBILITY_CHANGED_EVENT = av.LAYER_VISIBILITY_CHANGED_EVENT,CUTPLANES_CHANGE_EVENT = av.CUTPLANES_CHANGE_EVENT;

function LiveReviewClient(viewer) {
...
LiveReviewClient.prototype.joinLiveReviewSession = function (sessionId) {
  ...
  this.messageClient = _MessageClient__WEBPACK_IMPORTED_MODULE_0__["MessageClient"].GetInstance();
...
function ViewTransceiver(client) {
  ...
  this.attach = function (viewer, skipStateTracking) {
    ...
    if (!_viewer.hasEventListener(CAMERA_CHANGE_EVENT, sendCamera))
    _viewer.addEventListener(CAMERA_CHANGE_EVENT, sendCamera);

    if (!skipStateTracking) {
      _client.addEventListener("viewerState", onViewerState);

      if (!_viewer.hasEventListener(SELECTION_CHANGED_EVENT, sendViewerState)) {
        _viewer.addEventListener(SELECTION_CHANGED_EVENT, sendViewerState);
        _viewer.addEventListener(ISOLATE_EVENT, sendViewerState);
        _viewer.addEventListener(HIDE_EVENT, sendViewerState);
        _viewer.addEventListener(SHOW_EVENT, sendViewerState);
        _viewer.addEventListener(EXPLODE_CHANGE_EVENT, sendViewerState);
        _viewer.addEventListener(LAYER_VISIBILITY_CHANGED_EVENT, sendViewerState);
        _viewer.addEventListener(CUTPLANES_CHANGE_EVENT, sendViewerState);
      }
    }
  };
  ...
  this.detach = function () {
    ...
    if (_viewer) {
      _viewer.removeEventListener(CAMERA_CHANGE_EVENT, sendCamera);

      _viewer.removeEventListener(SELECTION_CHANGED_EVENT, sendViewerState);
      _viewer.removeEventListener(ISOLATE_EVENT, sendViewerState);
      _viewer.removeEventListener(HIDE_EVENT, sendViewerState);
      _viewer.removeEventListener(SHOW_EVENT, sendViewerState);
      _viewer.removeEventListener(EXPLODE_CHANGE_EVENT, sendViewerState);
      _viewer.removeEventListener(LAYER_VISIBILITY_CHANGED_EVENT, sendViewerState);
      _viewer.removeEventListener(CUTPLANES_CHANGE_EVENT, sendViewerState);
...
/***/ "./extensions/Collaboration/net/MessageClient.js":
/*!*******************************************************!*\
  !*** ./extensions/Collaboration/net/MessageClient.js ***!
  \*******************************************************/
/*! exports provided: setUserName, MessageClient */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var socket_io_client__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! socket.io-client */ "./extensions/Collaboration/node_modules/socket.io-client/lib/index.js");
/* harmony import */ var socket_io_client__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(socket_io_client__WEBPACK_IMPORTED_MODULE_0__);


var av = Autodesk.Viewing;
var logger = av.Private.logger;var
EnvironmentConfigurations = av.EnvironmentConfigurations,EventDispatcher = av.EventDispatcher,getEnv = av.getEnv;
...
function MessageClient(serverUrls, serverPath) {
  ...
  this.connect = function (sessionID) {
    ...
    if (typeof window.WebSocket !== "undefined") {
      ...
      if (!myio)
      myio = socket_io_client__WEBPACK_IMPORTED_MODULE_0__;
...
/***/ "./extensions/Collaboration/node_modules/after/index.js":
/*!**************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/after/index.js ***!
  \**************************************************************/
/*! no static exports found */
...
/***/ "./extensions/Collaboration/node_modules/arraybuffer.slice/index.js":
/*!**************************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/arraybuffer.slice/index.js ***!
  \**************************************************************************/
/*! no static exports found */
...
/***/ "./extensions/Collaboration/node_modules/backo2/index.js":
/*!***************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/backo2/index.js ***!
  \***************************************************************/
/*! no static exports found */
...
/***/ "./extensions/Collaboration/node_modules/base64-arraybuffer/lib/base64-arraybuffer.js":
/*!********************************************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/base64-arraybuffer/lib/base64-arraybuffer.js ***!
  \********************************************************************************************/
/*! no static exports found */
...
/***/ "./extensions/Collaboration/node_modules/blob/index.js":
/*!*************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/blob/index.js ***!
  \*************************************************************/
/*! no static exports found */
...
/***/ "./extensions/Collaboration/node_modules/component-bind/index.js":
/*!***********************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/component-bind/index.js ***!
  \***********************************************************************/
/*! no static exports found */
...
/***/ "./extensions/Collaboration/node_modules/component-emitter/index.js":
/*!**************************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/component-emitter/index.js ***!
  \**************************************************************************/
/*! no static exports found */
...
/***/ "./extensions/Collaboration/node_modules/component-inherit/index.js":
/*!**************************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/component-inherit/index.js ***!
  \**************************************************************************/
/*! no static exports found */
...
/***/ "./extensions/Collaboration/node_modules/debug/browser.js":
/*!****************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/debug/browser.js ***!
  \****************************************************************/
/*! no static exports found */
...
exports = module.exports = __webpack_require__(/*! ./debug */ "./extensions/Collaboration/node_modules/debug/debug.js");
exports.log = log;
...
function log() {
  ...
  return 'object' === (typeof console === "undefined" ? "undefined" : _typeof(console)) &&
  console.log &&
...
/***/ "./extensions/Collaboration/node_modules/debug/debug.js":
/*!**************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/debug/debug.js ***!
  \**************************************************************/
/*! no static exports found */
...
exports.humanize = __webpack_require__(/*! ms */ "./extensions/Collaboration/node_modules/ms/index.js");
...
/***/ "./extensions/Collaboration/node_modules/engine.io-client/index.js":
/*!*************************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/engine.io-client/index.js ***!
  \*************************************************************************/
/*! no static exports found */
...
module.exports = __webpack_require__(/*! ./lib/ */ "./extensions/Collaboration/node_modules/engine.io-client/lib/index.js");

/***/ }),

/***/ "./extensions/Collaboration/node_modules/engine.io-client/lib/index.js":
/*!*****************************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/engine.io-client/lib/index.js ***!
  \*****************************************************************************/
/*! no static exports found */
...
module.exports = __webpack_require__(/*! ./socket */ "./extensions/Collaboration/node_modules/engine.io-client/lib/socket.js");
...
/**
                                       ...
                                       *
                                       */
module.exports.parser = __webpack_require__(/*! engine.io-parser */ "./extensions/Collaboration/node_modules/engine.io-parser/lib/browser.js");

/***/ }),

/***/ "./extensions/Collaboration/node_modules/engine.io-client/lib/socket.js":
/*!******************************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/engine.io-client/lib/socket.js ***!
  \******************************************************************************/
/*! no static exports found */
...
var transports = __webpack_require__(/*! ./transports */ "./extensions/Collaboration/node_modules/engine.io-client/lib/transports/index.js");
var Emitter = __webpack_require__(/*! component-emitter */ "./extensions/Collaboration/node_modules/engine.io-client/node_modules/component-emitter/index.js");
var debug = __webpack_require__(/*! debug */ "./extensions/Collaboration/node_modules/debug/browser.js")('engine.io-client:socket');
var index = __webpack_require__(/*! indexof */ "./extensions/Collaboration/node_modules/indexof/index.js");
var parser = __webpack_require__(/*! engine.io-parser */ "./extensions/Collaboration/node_modules/engine.io-parser/lib/browser.js");
var parseuri = __webpack_require__(/*! parseuri */ "./extensions/Collaboration/node_modules/parseuri/index.js");
var parsejson = __webpack_require__(/*! parsejson */ "./extensions/Collaboration/node_modules/parsejson/index.js");
var parseqs = __webpack_require__(/*! parseqs */ "./extensions/Collaboration/node_modules/parseqs/index.js");
...
Socket.Transport = __webpack_require__(/*! ./transport */ "./extensions/Collaboration/node_modules/engine.io-client/lib/transport.js");
Socket.transports = __webpack_require__(/*! ./transports */ "./extensions/Collaboration/node_modules/engine.io-client/lib/transports/index.js");
Socket.parser = __webpack_require__(/*! engine.io-parser */ "./extensions/Collaboration/node_modules/engine.io-parser/lib/browser.js");
...
/***/ "./extensions/Collaboration/node_modules/engine.io-client/lib/transport.js":
/*!*********************************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/engine.io-client/lib/transport.js ***!
  \*********************************************************************************/
/*! no static exports found */
...
/***/ "./extensions/Collaboration/node_modules/engine.io-client/lib/transports/index.js":
/*!****************************************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/engine.io-client/lib/transports/index.js ***!
  \****************************************************************************************/
/*! no static exports found */
...
var XMLHttpRequest = __webpack_require__(/*! xmlhttprequest-ssl */ "./extensions/Collaboration/node_modules/engine.io-client/lib/xmlhttprequest.js");
var XHR = __webpack_require__(/*! ./polling-xhr */ "./extensions/Collaboration/node_modules/engine.io-client/lib/transports/polling-xhr.js");
var JSONP = __webpack_require__(/*! ./polling-jsonp */ "./extensions/Collaboration/node_modules/engine.io-client/lib/transports/polling-jsonp.js");
var websocket = __webpack_require__(/*! ./websocket */ "./extensions/Collaboration/node_modules/engine.io-client/lib/transports/websocket.js");
...
/***/ "./extensions/Collaboration/node_modules/engine.io-client/lib/transports/polling-jsonp.js":
/*!************************************************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/engine.io-client/lib/transports/polling-jsonp.js ***!
  \************************************************************************************************/
/*! no static exports found */
...
var Polling = __webpack_require__(/*! ./polling */ "./extensions/Collaboration/node_modules/engine.io-client/lib/transports/polling.js");
var inherit = __webpack_require__(/*! component-inherit */ "./extensions/Collaboration/node_modules/component-inherit/index.js");
...
/***/ "./extensions/Collaboration/node_modules/engine.io-client/lib/transports/polling-xhr.js":
/*!**********************************************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/engine.io-client/lib/transports/polling-xhr.js ***!
  \**********************************************************************************************/
/*! no static exports found */
...
var Emitter = __webpack_require__(/*! component-emitter */ "./extensions/Collaboration/node_modules/engine.io-client/node_modules/component-emitter/index.js");
var inherit = __webpack_require__(/*! component-inherit */ "./extensions/Collaboration/node_modules/component-inherit/index.js");
var debug = __webpack_require__(/*! debug */ "./extensions/Collaboration/node_modules/debug/browser.js")('engine.io-client:polling-xhr');
...
/***/ "./extensions/Collaboration/node_modules/engine.io-client/lib/transports/polling.js":
/*!******************************************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/engine.io-client/lib/transports/polling.js ***!
  \******************************************************************************************/
/*! no static exports found */
...
var Transport = __webpack_require__(/*! ../transport */ "./extensions/Collaboration/node_modules/engine.io-client/lib/transport.js");
var parseqs = __webpack_require__(/*! parseqs */ "./extensions/Collaboration/node_modules/parseqs/index.js");
var parser = __webpack_require__(/*! engine.io-parser */ "./extensions/Collaboration/node_modules/engine.io-parser/lib/browser.js");
var inherit = __webpack_require__(/*! component-inherit */ "./extensions/Collaboration/node_modules/component-inherit/index.js");
var yeast = __webpack_require__(/*! yeast */ "./extensions/Collaboration/node_modules/yeast/index.js");
var debug = __webpack_require__(/*! debug */ "./extensions/Collaboration/node_modules/debug/browser.js")('engine.io-client:polling');
...
/***/ "./extensions/Collaboration/node_modules/engine.io-client/lib/transports/websocket.js":
/*!********************************************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/engine.io-client/lib/transports/websocket.js ***!
  \********************************************************************************************/
/*! no static exports found */
...
var inherit = __webpack_require__(/*! component-inherit */ "./extensions/Collaboration/node_modules/component-inherit/index.js");
var yeast = __webpack_require__(/*! yeast */ "./extensions/Collaboration/node_modules/yeast/index.js");
var debug = __webpack_require__(/*! debug */ "./extensions/Collaboration/node_modules/debug/browser.js")('engine.io-client:websocket');
...
if (!WebSocket && typeof window === 'undefined') {
  try {
    WebSocket = __webpack_require__(/*! ws */ 0);
  } catch (e) {}
}
...
/***/ "./extensions/Collaboration/node_modules/engine.io-client/lib/xmlhttprequest.js":
/*!**************************************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/engine.io-client/lib/xmlhttprequest.js ***!
  \**************************************************************************************/
/*! no static exports found */
...
var hasCORS = __webpack_require__(/*! has-cors */ "./extensions/Collaboration/node_modules/has-cors/index.js");
...
/***/ "./extensions/Collaboration/node_modules/engine.io-client/node_modules/component-emitter/index.js":
/*!********************************************************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/engine.io-client/node_modules/component-emitter/index.js ***!
  \********************************************************************************************************/
/*! no static exports found */
...
/***/ "./extensions/Collaboration/node_modules/engine.io-parser/lib/browser.js":
/*!*******************************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/engine.io-parser/lib/browser.js ***!
  \*******************************************************************************/
/*! no static exports found */
...
var keys = __webpack_require__(/*! ./keys */ "./extensions/Collaboration/node_modules/engine.io-parser/lib/keys.js");
var hasBinary = __webpack_require__(/*! has-binary */ "./extensions/Collaboration/node_modules/engine.io-parser/node_modules/has-binary/index.js");
var sliceBuffer = __webpack_require__(/*! arraybuffer.slice */ "./extensions/Collaboration/node_modules/arraybuffer.slice/index.js");
var base64encoder = __webpack_require__(/*! base64-arraybuffer */ "./extensions/Collaboration/node_modules/base64-arraybuffer/lib/base64-arraybuffer.js");
var after = __webpack_require__(/*! after */ "./extensions/Collaboration/node_modules/after/index.js");
var utf8 = __webpack_require__(/*! utf8 */ "./extensions/Collaboration/node_modules/utf8/utf8.js");
...
var Blob = __webpack_require__(/*! blob */ "./extensions/Collaboration/node_modules/blob/index.js");
...
/***/ "./extensions/Collaboration/node_modules/engine.io-parser/lib/keys.js":
/*!****************************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/engine.io-parser/lib/keys.js ***!
  \****************************************************************************/
/*! no static exports found */
...
/***/ "./extensions/Collaboration/node_modules/engine.io-parser/node_modules/has-binary/index.js":
/*!*************************************************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/engine.io-parser/node_modules/has-binary/index.js ***!
  \*************************************************************************************************/
/*! no static exports found */
...
var isArray = __webpack_require__(/*! isarray */ "./extensions/Collaboration/node_modules/isarray/index.js");
...
function hasBinary(data) {
  ...
  function _hasBinary(obj) {
    ...
    } else if (obj && 'object' == _typeof(obj)) {
      if (obj.toJSON) {
        obj = obj.toJSON();
      }
...
/***/ "./extensions/Collaboration/node_modules/has-binary/index.js":
/*!*******************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/has-binary/index.js ***!
  \*******************************************************************/
/*! no static exports found */
...
/***/ "./extensions/Collaboration/node_modules/has-cors/index.js":
/*!*****************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/has-cors/index.js ***!
  \*****************************************************************/
/*! no static exports found */
...
/***/ "./extensions/Collaboration/node_modules/indexof/index.js":
/*!****************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/indexof/index.js ***!
  \****************************************************************/
/*! no static exports found */
...
/***/ "./extensions/Collaboration/node_modules/isarray/index.js":
/*!****************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/isarray/index.js ***!
  \****************************************************************/
/*! no static exports found */
...
/***/ "./extensions/Collaboration/node_modules/json3/lib/json3.js":
/*!******************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/json3/lib/json3.js ***!
  \******************************************************************/
/*! no static exports found */
...
/* WEBPACK VAR INJECTION */(function(module, global) {var __WEBPACK_AMD_DEFINE_RESULT__;function _typeof(obj) {"@babel/helpers - typeof";if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") {_typeof = function _typeof(obj) {return typeof obj;};} else {_typeof = function _typeof(obj) {return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj;};}return _typeof(obj);} /*! JSON v3.3.2 | http://bestiejs.github.io/json3 | Copyright 2012-2014, Kit Cambridge | http://kit.mit-license.org */
;(function () {
...
/***/ "./extensions/Collaboration/node_modules/ms/index.js":
/*!***********************************************************!*\
  !*** ./extensions/Collaboration/node_modules/ms/index.js ***!
  \***********************************************************/
/*! no static exports found */
...
/***/ "./extensions/Collaboration/node_modules/parsejson/index.js":
/*!******************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/parsejson/index.js ***!
  \******************************************************************/
/*! no static exports found */
...
/***/ "./extensions/Collaboration/node_modules/parseqs/index.js":
/*!****************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/parseqs/index.js ***!
  \****************************************************************/
/*! no static exports found */
...
/***/ "./extensions/Collaboration/node_modules/parseuri/index.js":
/*!*****************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/parseuri/index.js ***!
  \*****************************************************************/
/*! no static exports found */
...
/***/ "./extensions/Collaboration/node_modules/socket.io-client/lib/index.js":
/*!*****************************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/socket.io-client/lib/index.js ***!
  \*****************************************************************************/
/*! no static exports found */
...
var url = __webpack_require__(/*! ./url */ "./extensions/Collaboration/node_modules/socket.io-client/lib/url.js");
var parser = __webpack_require__(/*! socket.io-parser */ "./extensions/Collaboration/node_modules/socket.io-parser/index.js");
var Manager = __webpack_require__(/*! ./manager */ "./extensions/Collaboration/node_modules/socket.io-client/lib/manager.js");
var debug = __webpack_require__(/*! debug */ "./extensions/Collaboration/node_modules/debug/browser.js")('socket.io-client');
...
exports.Manager = __webpack_require__(/*! ./manager */ "./extensions/Collaboration/node_modules/socket.io-client/lib/manager.js");
exports.Socket = __webpack_require__(/*! ./socket */ "./extensions/Collaboration/node_modules/socket.io-client/lib/socket.js");

/***/ }),

/***/ "./extensions/Collaboration/node_modules/socket.io-client/lib/manager.js":
/*!*******************************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/socket.io-client/lib/manager.js ***!
  \*******************************************************************************/
/*! no static exports found */
...
var eio = __webpack_require__(/*! engine.io-client */ "./extensions/Collaboration/node_modules/engine.io-client/index.js");
var Socket = __webpack_require__(/*! ./socket */ "./extensions/Collaboration/node_modules/socket.io-client/lib/socket.js");
var Emitter = __webpack_require__(/*! component-emitter */ "./extensions/Collaboration/node_modules/component-emitter/index.js");
var parser = __webpack_require__(/*! socket.io-parser */ "./extensions/Collaboration/node_modules/socket.io-parser/index.js");
var on = __webpack_require__(/*! ./on */ "./extensions/Collaboration/node_modules/socket.io-client/lib/on.js");
var bind = __webpack_require__(/*! component-bind */ "./extensions/Collaboration/node_modules/component-bind/index.js");
var debug = __webpack_require__(/*! debug */ "./extensions/Collaboration/node_modules/debug/browser.js")('socket.io-client:manager');
var indexOf = __webpack_require__(/*! indexof */ "./extensions/Collaboration/node_modules/indexof/index.js");
var Backoff = __webpack_require__(/*! backo2 */ "./extensions/Collaboration/node_modules/backo2/index.js");
...
/***/ "./extensions/Collaboration/node_modules/socket.io-client/lib/on.js":
/*!**************************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/socket.io-client/lib/on.js ***!
  \**************************************************************************/
/*! no static exports found */
...
/***/ "./extensions/Collaboration/node_modules/socket.io-client/lib/socket.js":
/*!******************************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/socket.io-client/lib/socket.js ***!
  \******************************************************************************/
/*! no static exports found */
...
var parser = __webpack_require__(/*! socket.io-parser */ "./extensions/Collaboration/node_modules/socket.io-parser/index.js");
var Emitter = __webpack_require__(/*! component-emitter */ "./extensions/Collaboration/node_modules/component-emitter/index.js");
var toArray = __webpack_require__(/*! to-array */ "./extensions/Collaboration/node_modules/to-array/index.js");
var on = __webpack_require__(/*! ./on */ "./extensions/Collaboration/node_modules/socket.io-client/lib/on.js");
var bind = __webpack_require__(/*! component-bind */ "./extensions/Collaboration/node_modules/component-bind/index.js");
var debug = __webpack_require__(/*! debug */ "./extensions/Collaboration/node_modules/debug/browser.js")('socket.io-client:socket');
var hasBin = __webpack_require__(/*! has-binary */ "./extensions/Collaboration/node_modules/has-binary/index.js");
...
/***/ "./extensions/Collaboration/node_modules/socket.io-client/lib/url.js":
/*!***************************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/socket.io-client/lib/url.js ***!
  \***************************************************************************/
/*! no static exports found */
...
var parseuri = __webpack_require__(/*! parseuri */ "./extensions/Collaboration/node_modules/parseuri/index.js");
var debug = __webpack_require__(/*! debug */ "./extensions/Collaboration/node_modules/debug/browser.js")('socket.io-client:url');
...
/***/ "./extensions/Collaboration/node_modules/socket.io-parser/binary.js":
/*!**************************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/socket.io-parser/binary.js ***!
  \**************************************************************************/
/*! no static exports found */
...
/* WEBPACK VAR INJECTION */(function(global) {function _typeof(obj) {"@babel/helpers - typeof";if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") {_typeof = function _typeof(obj) {return typeof obj;};} else {_typeof = function _typeof(obj) {return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj;};}return _typeof(obj);} /*global Blob,File*/
...
var isArray = __webpack_require__(/*! isarray */ "./extensions/Collaboration/node_modules/isarray/index.js");
var isBuf = __webpack_require__(/*! ./is-buffer */ "./extensions/Collaboration/node_modules/socket.io-parser/is-buffer.js");
...
exports.deconstructPacket = function (packet) {
  ...
  function _deconstructPacket(data) {
    ...
    if (isBuf(data)) {
      ...
      return newData;
    } else if ('object' == _typeof(data) && !(data instanceof Date)) {
      var newData = {};
      for (var key in data) {
...
exports.reconstructPacket = function (packet, buffers) {
  ...
  function _reconstructPacket(data) {
    if (data && data._placeholder) {
      ...
      return data;
    } else if (data && 'object' == _typeof(data)) {
      for (var key in data) {
...
exports.removeBlobs = function (data, callback) {
  function _removeBlobs(obj, curKey, containingObject) {
    ...
    } else if (obj && 'object' == _typeof(obj) && !isBuf(obj)) {// and object
      for (var key in obj) {
...
/***/ "./extensions/Collaboration/node_modules/socket.io-parser/index.js":
/*!*************************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/socket.io-parser/index.js ***!
  \*************************************************************************/
/*! no static exports found */
...
var debug = __webpack_require__(/*! debug */ "./extensions/Collaboration/node_modules/debug/browser.js")('socket.io-parser');
var json = __webpack_require__(/*! json3 */ "./extensions/Collaboration/node_modules/json3/lib/json3.js");
var isArray = __webpack_require__(/*! isarray */ "./extensions/Collaboration/node_modules/isarray/index.js");
var Emitter = __webpack_require__(/*! component-emitter */ "./extensions/Collaboration/node_modules/socket.io-parser/node_modules/component-emitter/index.js");
var binary = __webpack_require__(/*! ./binary */ "./extensions/Collaboration/node_modules/socket.io-parser/binary.js");
var isBuf = __webpack_require__(/*! ./is-buffer */ "./extensions/Collaboration/node_modules/socket.io-parser/is-buffer.js");
...
/***/ "./extensions/Collaboration/node_modules/socket.io-parser/is-buffer.js":
/*!*****************************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/socket.io-parser/is-buffer.js ***!
  \*****************************************************************************/
/*! no static exports found */
...
/***/ "./extensions/Collaboration/node_modules/socket.io-parser/node_modules/component-emitter/index.js":
/*!********************************************************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/socket.io-parser/node_modules/component-emitter/index.js ***!
  \********************************************************************************************************/
/*! no static exports found */
...
/***/ "./extensions/Collaboration/node_modules/to-array/index.js":
/*!*****************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/to-array/index.js ***!
  \*****************************************************************/
/*! no static exports found */
...
/***/ "./extensions/Collaboration/node_modules/utf8/utf8.js":
/*!************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/utf8/utf8.js ***!
  \************************************************************/
/*! no static exports found */
...
/* WEBPACK VAR INJECTION */(function(module, global) {var __WEBPACK_AMD_DEFINE_RESULT__;function _typeof(obj) {"@babel/helpers - typeof";if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") {_typeof = function _typeof(obj) {return typeof obj;};} else {_typeof = function _typeof(obj) {return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj;};}return _typeof(obj);} /*! https://mths.be/utf8js v2.0.0 by @mathias */
;(function (root) {
...
/***/ "./extensions/Collaboration/node_modules/yeast/index.js":
/*!**************************************************************!*\
  !*** ./extensions/Collaboration/node_modules/yeast/index.js ***!
  \**************************************************************/
/*! no static exports found */
