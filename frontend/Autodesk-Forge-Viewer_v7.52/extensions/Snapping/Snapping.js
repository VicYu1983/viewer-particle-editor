    ...
    if (attributes.index !== undefined) {
      ...
      if (i < facesTopology.length) {
        ...
        for (var _j = 0; _j < indexList.length; _j += 3) {
          vA.set(
          positions[indexList[_j] * stride],
          positions[indexList[_j] * stride + 1],
          positions[indexList[_j] * stride + 2]);

          vB.set(
          positions[indexList[_j + 1] * stride],
          positions[indexList[_j + 1] * stride + 1],
          positions[indexList[_j + 1] * stride + 2]);

          vC.set(
          positions[indexList[_j + 2] * stride],
          positions[indexList[_j + 2] * stride + 1],
          positions[indexList[_j + 2] * stride + 2]);
