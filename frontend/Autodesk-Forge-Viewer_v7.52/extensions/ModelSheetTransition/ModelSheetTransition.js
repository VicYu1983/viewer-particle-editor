...
var setCutPlane = /*#__PURE__*/function () {var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(viewer, matrix, clearSelectedFloor) {var pos, rot, scale, sectionExt, normal, _levelsExtension$floo, levelsExtension, prevLock;return regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
...
/* harmony import */ var _SheetToModel__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./SheetToModel */ "./extensions/ModelSheetTransition/SheetToModel.js");
/* harmony import */ var _ModelToSheet__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./ModelToSheet */ "./extensions/ModelSheetTransition/ModelToSheet.js");
/* harmony import */ var _UI_ModelSheetGenericUI__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./UI/ModelSheetGenericUI */ "./extensions/ModelSheetTransition/UI/ModelSheetGenericUI.js");
/* harmony import */ var _UI_ModelSheet3DMarker__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./UI/ModelSheet3DMarker */ "./extensions/ModelSheetTransition/UI/ModelSheet3DMarker.js");
/* harmony import */ var _BoundsPlane__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./BoundsPlane */ "./extensions/ModelSheetTransition/BoundsPlane.js");
...
ModelSheetTransitionExtension = /*#__PURE__*/function (_Autodesk$Viewing$Ext) {_inherits(ModelSheetTransitionExtension, _Autodesk$Viewing$Ext);var _super = _createSuper(ModelSheetTransitionExtension);
  ...
  function ModelSheetTransitionExtension(viewer) {var _this;var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};_classCallCheck(this, ModelSheetTransitionExtension);
    ...
    _this.sheetToModel = new _SheetToModel__WEBPACK_IMPORTED_MODULE_3__["default"](_assertThisInitialized(_this));
    _this.modelToSheet = new _ModelToSheet__WEBPACK_IMPORTED_MODULE_4__["default"](_assertThisInitialized(_this));
    ...
    _this.markers = {};return _this;
                ...
                this.extendLocalization(_ModelSheetTransitionLocals__WEBPACK_IMPORTED_MODULE_1__["locales"]);_context.next = 9;return (
    ...
    {var _this3 = this;
      ...
      this.ui3D = this.options.ui3D && new this.options.ui3D(onHide) || new _UI_ModelSheetGenericUI__WEBPACK_IMPORTED_MODULE_5__["default"](this.viewer, onHide);

      this.boundsPlane = new _BoundsPlane__WEBPACK_IMPORTED_MODULE_7__["default"](this.viewer, OverlayName);
      ...
      model) {var _this4 = this;var relatedViewports, vpKeys, keysToRemove;return regeneratorRuntime.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:if (!(
                ...
                relatedViewports.forEach(function (vp) {
                  ...
                  var marker = new _UI_ModelSheet3DMarker__WEBPACK_IMPORTED_MODULE_6__["default"](_this4, vp, model, _this4.ui3D, _this4.areMarkersVisible);
    ...
    key) {
      ...
      node, viewport, model3D) {var model, unitScale, viewportBounds, matrix, model3DMatrix, clearSelectedFloor;return regeneratorRuntime.wrap(function _callee5$(_context5) {while (1) {switch (_context5.prev = _context5.next) {case 0:
                ...
                Object(_ModelSheetCommon__WEBPACK_IMPORTED_MODULE_0__["setCutPlane"])(this.viewer, matrix, clearSelectedFloor);
    ...
    // If this model was changed due to a transition, reset those changes
      ...
      if (resetTransformAndViewport) {
        ...
        Object(_ModelSheetCommon__WEBPACK_IMPORTED_MODULE_0__["resetModelTransformAndViewport"])(this.viewer, model);
        Object(_ModelSheetCommon__WEBPACK_IMPORTED_MODULE_0__["fitToBounds"])(this.viewer, model);
      }
    ...
    this.viewer = extension.viewer;
      ...
      model2D) {var nodeAndViewportPromise, bubbleNode, viewport, _yield$nodeAndViewpor, model3D, unitScale, matrix, modelToViewerTransform, viewportBounds;return regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:if (
                ...
                viewportBounds) {_context.next = 38;break;}_context.next = 38;return (
                  Object(_ModelSheetCommon__WEBPACK_IMPORTED_MODULE_1__["setViewportBounds"])(this.viewer, model2D, viewportBounds, _ModelSheetConstants__WEBPACK_IMPORTED_MODULE_0__["HIDE_DURATION"]));case 38:
                ...
                Autodesk.Viewing.Private.analytics.track(Autodesk.ModelSheetTransition.AnalyticsEventName, {
                  ...
                  file_3d_extension: bubbleNode.getInputFileType() });case 39:case "end":return _context.stop();}}}, _callee, this, [[6, 14]]);}));function transition2Dto3D(_x) {return _transition2Dto3D.apply(this, arguments);}return transition2Dto3D;}() }]);return SheetToModel;}();
...
/*!***************************************************************!*\
  !*** ./res/locales/en/nobundle-modelSheetTransition.loc.json ***!
  \***************************************************************/
/*! exports provided: @@locale, @@context, View drawing in 3D, Fetching alignment information..., Current view is not supported by View drawing in 3D, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"@@locale\":\"en\",\"@@context\":\"ModelSheetTransition Extension\",\"View drawing in 3D\":\"View drawing in 3D\",\"Fetching alignment information...\":\"Fetching alignment information...'\",\"Current view is not supported by View drawing in 3D\":\"Current view is not supported by View drawing in 3D\"}");
