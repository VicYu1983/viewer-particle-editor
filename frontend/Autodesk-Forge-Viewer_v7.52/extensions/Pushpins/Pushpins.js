...
var content = __webpack_require__(/*! !../../node_modules/css-loader!../../node_modules/sass-loader/dist/cjs.js!./PushPinExtension.css */ "./node_modules/css-loader/index.js!./node_modules/sass-loader/dist/cjs.js!./extensions/Pushpins/PushPinExtension.css");
...
/* harmony import */ var _PushPinLocales__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./PushPinLocales */ "./extensions/Pushpins/PushPinLocales.js");
/* harmony import */ var _PushPinExtension_css__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./PushPinExtension.css */ "./extensions/Pushpins/PushPinExtension.css");
/* harmony import */ var _PushPinExtension_css__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_PushPinExtension_css__WEBPACK_IMPORTED_MODULE_9__);
...
PushPinExtension = /*#__PURE__*/function (_Autodesk$Viewing$Ext) {_inherits(PushPinExtension, _Autodesk$Viewing$Ext);var _super = _createSuper(PushPinExtension);
  function PushPinExtension(viewer) {var _this;var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};_classCallCheck(this, PushPinExtension);
    ...
    {
      this.extendLocalization(_PushPinLocales__WEBPACK_IMPORTED_MODULE_8__["locales"]);
    ...
    {var _this2 = this;
      ...
      if (reset) {
        ...
        for (var _i = 0, _Object$values = Object.values(_PushPinEvents__WEBPACK_IMPORTED_MODULE_0__["PUSHPIN_EVENTS"]); _i < _Object$values.length; _i++) {var value = _Object$values[_i];
...

    {
      ...
      if (Autodesk.Viewing.isMobileDevice()) {
        this.observer = new _PushPinObserver__WEBPACK_IMPORTED_MODULE_6__["default"](this.pushPinManager);
      }
...

    {
      ...
      this.tool = new _PushPinTools__WEBPACK_IMPORTED_MODULE_2__["default"](this.viewer, this.pushPinManager);
    ...
    data) {
      ...
      this.pushPinManager.fireEvent({ type: _PushPinEvents__WEBPACK_IMPORTED_MODULE_0__["PUSHPIN_EVENTS"].PUSH_PIN_EDIT_START_EVENT });
    } }, { key: "endCreateItem", value: function endCreateItem()

    {
      this.tool.endCreateItem();
      this.updateButtonsStatus();
      this.pushPinManager.fireEvent({ type: _PushPinEvents__WEBPACK_IMPORTED_MODULE_0__["PUSHPIN_EVENTS"].PUSH_PIN_EDIT_END_EVENT });
    ...
    // public interfaces routing to push pin manager for clients to call
      ...
      this.pushPinManager.fireEvent({ type: _PushPinEvents__WEBPACK_IMPORTED_MODULE_0__["PUSHPIN_EVENTS"].PUSH_PIN_ITEMS_LOADED, value: null });
    }
...
PushPinItem = /*#__PURE__*/function () {
  function PushPinItem() {_classCallCheck(this, PushPinItem);
    ...
    state) {
      ...
      this.itemData.viewerState.attributesVersion = _PushPinConstants__WEBPACK_IMPORTED_MODULE_1__["ATTRIBUTES_VERSION"];
...
/***/ "./extensions/Pushpins/PushPinLocales.js":
/*!***********************************************!*\
  !*** ./extensions/Pushpins/PushPinLocales.js ***!
  \***********************************************/
...
/* harmony import */ var _res_locales_en_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../res/locales/en/nobundle-pushpins.loc.json */ "./res/locales/en/nobundle-pushpins.loc.json");
var _res_locales_en_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_0___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../res/locales/en/nobundle-pushpins.loc.json */ "./res/locales/en/nobundle-pushpins.loc.json", 1);
/* harmony import */ var _res_locales_en_GB_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../res/locales/en-GB/nobundle-pushpins.loc.json */ "./res/locales/en-GB/nobundle-pushpins.loc.json");
var _res_locales_en_GB_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_1___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../res/locales/en-GB/nobundle-pushpins.loc.json */ "./res/locales/en-GB/nobundle-pushpins.loc.json", 1);
/* harmony import */ var _res_locales_cs_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../res/locales/cs/nobundle-pushpins.loc.json */ "./res/locales/cs/nobundle-pushpins.loc.json");
var _res_locales_cs_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_2___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../res/locales/cs/nobundle-pushpins.loc.json */ "./res/locales/cs/nobundle-pushpins.loc.json", 1);
/* harmony import */ var _res_locales_de_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../res/locales/de/nobundle-pushpins.loc.json */ "./res/locales/de/nobundle-pushpins.loc.json");
var _res_locales_de_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_3___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../res/locales/de/nobundle-pushpins.loc.json */ "./res/locales/de/nobundle-pushpins.loc.json", 1);
/* harmony import */ var _res_locales_es_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../res/locales/es/nobundle-pushpins.loc.json */ "./res/locales/es/nobundle-pushpins.loc.json");
var _res_locales_es_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_4___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../res/locales/es/nobundle-pushpins.loc.json */ "./res/locales/es/nobundle-pushpins.loc.json", 1);
/* harmony import */ var _res_locales_fr_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../res/locales/fr/nobundle-pushpins.loc.json */ "./res/locales/fr/nobundle-pushpins.loc.json");
var _res_locales_fr_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_5___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../res/locales/fr/nobundle-pushpins.loc.json */ "./res/locales/fr/nobundle-pushpins.loc.json", 1);
/* harmony import */ var _res_locales_fr_CA_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../res/locales/fr-CA/nobundle-pushpins.loc.json */ "./res/locales/fr-CA/nobundle-pushpins.loc.json");
var _res_locales_fr_CA_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_6___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../res/locales/fr-CA/nobundle-pushpins.loc.json */ "./res/locales/fr-CA/nobundle-pushpins.loc.json", 1);
/* harmony import */ var _res_locales_it_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../res/locales/it/nobundle-pushpins.loc.json */ "./res/locales/it/nobundle-pushpins.loc.json");
var _res_locales_it_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_7___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../res/locales/it/nobundle-pushpins.loc.json */ "./res/locales/it/nobundle-pushpins.loc.json", 1);
/* harmony import */ var _res_locales_ja_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../res/locales/ja/nobundle-pushpins.loc.json */ "./res/locales/ja/nobundle-pushpins.loc.json");
var _res_locales_ja_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_8___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../res/locales/ja/nobundle-pushpins.loc.json */ "./res/locales/ja/nobundle-pushpins.loc.json", 1);
/* harmony import */ var _res_locales_ko_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../res/locales/ko/nobundle-pushpins.loc.json */ "./res/locales/ko/nobundle-pushpins.loc.json");
var _res_locales_ko_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_9___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../res/locales/ko/nobundle-pushpins.loc.json */ "./res/locales/ko/nobundle-pushpins.loc.json", 1);
/* harmony import */ var _res_locales_pl_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../res/locales/pl/nobundle-pushpins.loc.json */ "./res/locales/pl/nobundle-pushpins.loc.json");
var _res_locales_pl_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_10___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../res/locales/pl/nobundle-pushpins.loc.json */ "./res/locales/pl/nobundle-pushpins.loc.json", 1);
/* harmony import */ var _res_locales_pt_BR_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../res/locales/pt-BR/nobundle-pushpins.loc.json */ "./res/locales/pt-BR/nobundle-pushpins.loc.json");
var _res_locales_pt_BR_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_11___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../res/locales/pt-BR/nobundle-pushpins.loc.json */ "./res/locales/pt-BR/nobundle-pushpins.loc.json", 1);
/* harmony import */ var _res_locales_ru_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../res/locales/ru/nobundle-pushpins.loc.json */ "./res/locales/ru/nobundle-pushpins.loc.json");
var _res_locales_ru_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_12___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../res/locales/ru/nobundle-pushpins.loc.json */ "./res/locales/ru/nobundle-pushpins.loc.json", 1);
/* harmony import */ var _res_locales_tr_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../res/locales/tr/nobundle-pushpins.loc.json */ "./res/locales/tr/nobundle-pushpins.loc.json");
var _res_locales_tr_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_13___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../res/locales/tr/nobundle-pushpins.loc.json */ "./res/locales/tr/nobundle-pushpins.loc.json", 1);
/* harmony import */ var _res_locales_zh_HANS_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../res/locales/zh-HANS/nobundle-pushpins.loc.json */ "./res/locales/zh-HANS/nobundle-pushpins.loc.json");
var _res_locales_zh_HANS_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_14___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../res/locales/zh-HANS/nobundle-pushpins.loc.json */ "./res/locales/zh-HANS/nobundle-pushpins.loc.json", 1);
/* harmony import */ var _res_locales_zh_HANT_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../res/locales/zh-HANT/nobundle-pushpins.loc.json */ "./res/locales/zh-HANT/nobundle-pushpins.loc.json");
var _res_locales_zh_HANT_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_15___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../res/locales/zh-HANT/nobundle-pushpins.loc.json */ "./res/locales/zh-HANT/nobundle-pushpins.loc.json", 1);
/* harmony import */ var _res_locales_zh_HK_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../res/locales/zh-HK/nobundle-pushpins.loc.json */ "./res/locales/zh-HK/nobundle-pushpins.loc.json");
var _res_locales_zh_HK_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_16___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../res/locales/zh-HK/nobundle-pushpins.loc.json */ "./res/locales/zh-HK/nobundle-pushpins.loc.json", 1);
/* harmony import */ var _res_locales_nl_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../res/locales/nl/nobundle-pushpins.loc.json */ "./res/locales/nl/nobundle-pushpins.loc.json");
var _res_locales_nl_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_17___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../res/locales/nl/nobundle-pushpins.loc.json */ "./res/locales/nl/nobundle-pushpins.loc.json", 1);
/* harmony import */ var _res_locales_sv_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../../res/locales/sv/nobundle-pushpins.loc.json */ "./res/locales/sv/nobundle-pushpins.loc.json");
var _res_locales_sv_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_18___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../res/locales/sv/nobundle-pushpins.loc.json */ "./res/locales/sv/nobundle-pushpins.loc.json", 1);
/* harmony import */ var _res_locales_da_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../../res/locales/da/nobundle-pushpins.loc.json */ "./res/locales/da/nobundle-pushpins.loc.json");
var _res_locales_da_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_19___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../res/locales/da/nobundle-pushpins.loc.json */ "./res/locales/da/nobundle-pushpins.loc.json", 1);
/* harmony import */ var _res_locales_no_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../../res/locales/no/nobundle-pushpins.loc.json */ "./res/locales/no/nobundle-pushpins.loc.json");
var _res_locales_no_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_20___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../res/locales/no/nobundle-pushpins.loc.json */ "./res/locales/no/nobundle-pushpins.loc.json", 1);
/**
...
var locales = {
  en: _res_locales_en_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_0__,
  "en-GB": _res_locales_en_GB_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_1__,
  cs: _res_locales_cs_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_2__,
  de: _res_locales_de_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_3__,
  es: _res_locales_es_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_4__,
  fr: _res_locales_fr_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_5__,
  "fr-CA": _res_locales_fr_CA_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_6__,
  it: _res_locales_it_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_7__,
  ja: _res_locales_ja_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_8__,
  ko: _res_locales_ko_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_9__,
  pl: _res_locales_pl_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_10__,
  "pt-BR": _res_locales_pt_BR_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_11__,
  ru: _res_locales_ru_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_12__,
  tr: _res_locales_tr_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_13__,
  "zh-HANS": _res_locales_zh_HANS_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_14__,
  "zh-HANT": _res_locales_zh_HANT_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_15__,
  "zh-HK": _res_locales_zh_HK_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_16__,
  nl: _res_locales_nl_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_17__,
  sv: _res_locales_sv_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_18__,
  da: _res_locales_da_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_19__,
  no: _res_locales_no_nobundle_pushpins_loc_json__WEBPACK_IMPORTED_MODULE_20__ };
...
PushPinManager = /*#__PURE__*/function (_Autodesk$Viewing$Eve) {_inherits(PushPinManager, _Autodesk$Viewing$Eve);var _super = _createSuper(PushPinManager);
  function PushPinManager(viewer) {var _this;var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};_classCallCheck(this, PushPinManager);
    ...
    _this.addEventListener(_PushPinEvents__WEBPACK_IMPORTED_MODULE_1__["PUSHPIN_EVENTS"].PUSH_PIN_EDIT_START_EVENT, _this.onPushpinEditStartBinded);
    _this.addEventListener(_PushPinEvents__WEBPACK_IMPORTED_MODULE_1__["PUSHPIN_EVENTS"].PUSH_PIN_EDIT_END_EVENT, _this.onPushpinEditEndBinded);
    _this.addEventListener(_PushPinEvents__WEBPACK_IMPORTED_MODULE_1__["PUSHPIN_EVENTS"].PUSH_PIN_REMOVED_EVENT, _this.onPushpinEditEndBinded);return _this;
      ...
      return new Promise(function (resolve, reject) {var _item$data$position =
        ...
        if (_this4.viewer.model.is2d()) {
          ...
          if (!_this4.viewer.model.isPageCoordinates()) {
            thumbnailSizeWorld = Object(_PushPinUtils__WEBPACK_IMPORTED_MODULE_2__["clientToWorldLeaflet"])(_this4.viewer, _PushPinConstants__WEBPACK_IMPORTED_MODULE_3__["thumbnailOriginalPixelSize"], 0);
            zeroWorld = Object(_PushPinUtils__WEBPACK_IMPORTED_MODULE_2__["clientToWorldLeaflet"])(_this4.viewer, 0, 0);
          } else {
            thumbnailSizeWorld = _this4.viewer.clientToWorld(_PushPinConstants__WEBPACK_IMPORTED_MODULE_3__["thumbnailOriginalPixelSize"], 0, undefined, true).point;
    ...
    // Update locationIds array inside the item's data.
      ...
      if (this.viewer.model.isLeaflet()) {
        var pWorld = Object(_PushPinUtils__WEBPACK_IMPORTED_MODULE_2__["applyPdfWorldScaling"])(this.viewer, item.data);
  ...
  function PushPinTool(viewer, pushPinManager) {_classCallCheck(this, PushPinTool);
    ...
    event) {
      ...
      if (result && this.pushPinInitData) {var _result$model;
        ...
        Object(_PushPinUtils__WEBPACK_IMPORTED_MODULE_1__["invertModelTransform"])(this.pushPinInitData.position, result.model);
...
/*!*********************************************!*\
  !*** ./extensions/Pushpins/PushPinUtils.js ***!
  \*********************************************/
/*! exports provided: clientToWorldLeaflet, clientToWorld, applyPdfWorldScaling, worldToClient, convertPdfToLeaflet, applyModelTransform, invertModelTransform */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "applyModelTransform", function() { return applyModelTransform; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "invertModelTransform", function() { return invertModelTransform; });
...
function applyModelTransform(point, model) {
...
function invertModelTransform(point, model) {
  var modelTransform = model === null || model === void 0 ? void 0 : model.getModelTransform();
...
PushPinBillboardTool2D = /*#__PURE__*/function () {
  function PushPinBillboardTool2D(viewer) {_classCallCheck(this, PushPinBillboardTool2D);
    ...
    item) {
      item.data.attributesVersion = _PushPinConstants__WEBPACK_IMPORTED_MODULE_2__["ATTRIBUTES_VERSION"];
...
/* harmony import */ var _PushPinUtils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../PushPinUtils */ "./extensions/Pushpins/PushPinUtils.js");
function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}
...
PushPinBillboardTool3D = /*#__PURE__*/function () {
  function PushPinBillboardTool3D(viewer) {var _this = this;var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};_classCallCheck(this, PushPinBillboardTool3D);
    ...
    pushpin) {
      ...
      Object(_PushPinUtils__WEBPACK_IMPORTED_MODULE_3__["applyModelTransform"])(p, model);
    ...
    item) {
      item.data.attributesVersion = _PushPinConstants__WEBPACK_IMPORTED_MODULE_1__["ATTRIBUTES_VERSION"];

      this.initNewPushpin(item);

      item.setViewerState(Object(_PushPins3D_PushPinViewerState__WEBPACK_IMPORTED_MODULE_2__["generateMetadata"])(this.viewer, item));
...
var generateMetadata = function generateMetadata(viewer, item) {
  var globalOffset = viewer.model ? viewer.model.getData().globalOffset : null;
...
var restoreViewState = function restoreViewState(viewer, item, immediate) {
...
/* harmony import */ var _PushPinUtils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../PushPinUtils */ "./extensions/Pushpins/PushPinUtils.js");
function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}
  ...
  function RenderHandler3D(viewerApi, pushPinManager) {var _this = this;_classCallCheck(this, RenderHandler3D);
    ...
    event) {
      if (event.value) {
        ...
        this.pushpinBillboardTool.selectPushpin(this.selectedItem);
        Object(_PushPins3D_PushPinViewerState__WEBPACK_IMPORTED_MODULE_3__["restoreViewState"])(this.viewer, this.selectedItem, this.pushPinManager.restoreViewerStateImmediate);
    ...
    e) {var _this4 = this;
      if (this.selectedItem.marker.dragging) {
        ...
        if (result) {
          ...
          Object(_PushPinUtils__WEBPACK_IMPORTED_MODULE_5__["invertModelTransform"])(this.selectedItem.data.position, result.model);
...
/***/ "./node_modules/css-loader/index.js!./node_modules/sass-loader/dist/cjs.js!./extensions/Pushpins/PushPinExtension.css":
/*!*******************************************************************************************************************!*\
  !*** ./node_modules/css-loader!./node_modules/sass-loader/dist/cjs.js!./extensions/Pushpins/PushPinExtension.css ***!
  \*******************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./res/locales/en/nobundle-pushpins.loc.json":
/*!***************************************************!*\
  !*** ./res/locales/en/nobundle-pushpins.loc.json ***!
  \***************************************************/
/*! exports provided: @@locale, @@context, No issue in current doc, Show all issues, Hide all issues, No RFI in current doc, Show all RFIs, Hide all RFIs, No field issue in current doc, Show all field issues, Hide all field issues, default */
...
/***/ "./res/locales/es/nobundle-pushpins.loc.json":
/*!***************************************************!*\
  !*** ./res/locales/es/nobundle-pushpins.loc.json ***!
  \***************************************************/
/*! exports provided: @@locale, @@context, No issue in current doc, Show all issues, Hide all issues, No RFI in current doc, Show all RFIs, Hide all RFIs, No field issue in current doc, Show all field issues, Hide all field issues, default */
...
/***/ "./res/locales/it/nobundle-pushpins.loc.json":
/*!***************************************************!*\
  !*** ./res/locales/it/nobundle-pushpins.loc.json ***!
  \***************************************************/
/*! exports provided: @@locale, @@context, No issue in current doc, Show all issues, Hide all issues, No RFI in current doc, Show all RFIs, Hide all RFIs, No field issue in current doc, Show all field issues, Hide all field issues, default */
...
/***/ "./res/locales/ko/nobundle-pushpins.loc.json":
/*!***************************************************!*\
  !*** ./res/locales/ko/nobundle-pushpins.loc.json ***!
  \***************************************************/
/*! exports provided: @@locale, @@context, No issue in current doc, Show all issues, Hide all issues, No RFI in current doc, Show all RFIs, Hide all RFIs, No field issue in current doc, Show all field issues, Hide all field issues, default */
...
/***/ "./res/locales/nl/nobundle-pushpins.loc.json":
/*!***************************************************!*\
  !*** ./res/locales/nl/nobundle-pushpins.loc.json ***!
  \***************************************************/
/*! exports provided: @@locale, @@context, No issue in current doc, Show all issues, Hide all issues, No RFI in current doc, Show all RFIs, Hide all RFIs, No field issue in current doc, Show all field issues, Hide all field issues, default */
...
/***/ "./res/locales/pl/nobundle-pushpins.loc.json":
/*!***************************************************!*\
  !*** ./res/locales/pl/nobundle-pushpins.loc.json ***!
  \***************************************************/
/*! exports provided: @@locale, @@context, No issue in current doc, Show all issues, Hide all issues, No RFI in current doc, Show all RFIs, Hide all RFIs, No field issue in current doc, Show all field issues, Hide all field issues, default */
...
/***/ "./res/locales/pt-BR/nobundle-pushpins.loc.json":
/*!******************************************************!*\
  !*** ./res/locales/pt-BR/nobundle-pushpins.loc.json ***!
  \******************************************************/
/*! exports provided: @@locale, @@context, No issue in current doc, Show all issues, Hide all issues, No RFI in current doc, Show all RFIs, Hide all RFIs, No field issue in current doc, Show all field issues, Hide all field issues, default */
...
/***/ "./res/locales/zh-HANT/nobundle-pushpins.loc.json":
/*!********************************************************!*\
  !*** ./res/locales/zh-HANT/nobundle-pushpins.loc.json ***!
  \********************************************************/
/*! exports provided: @@locale, @@context, No issue in current doc, Show all issues, Hide all issues, No RFI in current doc, Show all RFIs, Hide all RFIs, No field issue in current doc, Show all field issues, Hide all field issues, default */
...
/***/ "./res/locales/zh-HK/nobundle-pushpins.loc.json":
/*!******************************************************!*\
  !*** ./res/locales/zh-HK/nobundle-pushpins.loc.json ***!
  \******************************************************/
/*! exports provided: @@locale, @@context, No issue in current doc, Show all issues, Hide all issues, No RFI in current doc, Show all RFIs, Hide all RFIs, No field issue in current doc, Show all field issues, Hide all field issues, default */
...
module.exports = JSON.parse("{\"@@locale\":\"zh-hk\",\"@@context\":\"圖釘擴充功能\",\"No issue in current doc\":\"目前文件中沒有問題\",\"Show all issues\":\"展示所有問題\",\"Hide all issues\":\"隱藏所有問題\",\"No RFI in current doc\":\"目前文件中沒有 RFI\",\"Show all RFIs\":\"展示所有 RFI\",\"Hide all RFIs\":\"隱藏所有 RFI\",\"No field issue in current doc\":\"目前文件中沒有現場問題\",\"Show all field issues\":\"展示所有現場問題\",\"Hide all field issues\":\"隱藏所有現場問題\"}");
