...
(function () {
    ...
    class ColorTextAnimationShader extends BasicShader {
        constructor() {
            super();
        }
        ...
        doWriteFragmentShader() {
            return `
                ...
                vec3 t = vec3(time*0.4+uv.y*0.1,0.5,1.0);
                vec3 ch_color = hsv2rgb_smooth(t);
    ...
    vic.shaders.ColorTextAnimationShader = ColorTextAnimationShader;
})()